...
## [0.2.0](https://github.com/rrambul/mindforge/compare/v0.1.0...v0.2.0) (2026-09-25)
...
* **api:** say why the process is ending, on stderr, synchronously (§14.2) ([1444f62](https://github.com/rrambul/mindforge/commit/1444f6289d835b381bac1c7ee5b0936c68f33f8c))
...
* **api:** the exercises module, adaptation, and the bridge endpoint (FR-X, FR-H, FR-D) ([37e5d6d](https://github.com/rrambul/mindforge/commit/37e5d6d7147f0b9aacc4397473c5fa46e38162e7))
...
* **core:** the exercise contracts and how a lesson landed (FR-X, FR-H, FR-D) ([387f32c](https://github.com/rrambul/mindforge/commit/387f32cf7d3e9ed686aee6ef7df77a0113c017a5))
...
* **db:** exercises, attempts, hints, reviews and adjustments (FR-X, FR-H, FR-D) ([beebc51](https://github.com/rrambul/mindforge/commit/beebc513a088155320f1d426f3c2aca878ad0f7f))
* **db:** export curriculum progress to the portfolio ([71edeb7](https://github.com/rrambul/mindforge/commit/71edeb7c3ee91dd90982cb54af9272f0c1556c72))
...
* **lessons:** a sandboxed test runner for JS, TS and Python (FR-X3) ([2afb623](https://github.com/rrambul/mindforge/commit/2afb6231a730e72a9ec59e82af39c6854c3d5b4f))
...
* **teach:** end every lesson with a humanizer pass, and report skills a run never used (FR-K3) ([20aaf3a](https://github.com/rrambul/mindforge/commit/20aaf3a57323ab0fc12791a267056b93336fb346))
...
* **teach:** lessons are mostly doing, and a bridge reaches the run (Phase 0, FR-D2) ([8ec7989](https://github.com/rrambul/mindforge/commit/8ec7989a5797ba65554fade8dfb93e036dd2bfdb))
...
* **web:** exercises beside the lesson, hints, whiteboards, tasks and adaptation ([04bb271](https://github.com/rrambul/mindforge/commit/04bb271f9316f58737d9d3ca60d24c05ba18557f))
...
* **worker:** put:workspace can delete named files, and reindexes the deletion (FR-K4) ([1937e85](https://github.com/rrambul/mindforge/commit/1937e85f3d0d7c69e89b4c6d1ddb22ae2eb96abd))
...
* **workspace,llm:** exercises in lesson files, the briefing adapts, hint and review calls ([68b38b1](https://github.com/rrambul/mindforge/commit/68b38b10b9e396b30fefaa9335f4ffa95f9c4eca))
...
* **workspace:** warn when a lesson keeps dashes as punctuation after its humanizer pass (FR-K3) ([932410f](https://github.com/rrambul/mindforge/commit/932410f21465a10771c3930ad93457fcba009f7b))


### Fixed

* **api:** type reportExit's writer as returning nothing, so a test double fits ([3a74f51](https://github.com/rrambul/mindforge/commit/3a74f51f2f06510e8fd6476792bebc6ae0605e5f))
...
* **curriculum:** a module never lists a lesson before one it depends on (FR-K7) ([7c6b362](https://github.com/rrambul/mindforge/commit/7c6b362705349233007cc9d3640439af9bcb21fa))
...
* **dev:** pass CLAUDE_CONFIG_DIR through to dev tasks (FR-T8) ([30a13b7](https://github.com/rrambul/mindforge/commit/30a13b725b1716e40442cec1be69262b357a5191))
...
* **teach:** a run reports what it wrote, by file, and writes no learning records (FR-T3) ([a420b06](https://github.com/rrambul/mindforge/commit/a420b06d75d1af482a9b48a72182c92ed5c4bb2b))
* **teach:** open the next lesson's module when no track is marked active (FR-K2) ([99db1e3](https://github.com/rrambul/mindforge/commit/99db1e317478f165ad3e62d87f475ae05d50acdb))
...
* **web:** a whiteboard stroke lands under the pointer after the canvas moves (FR-X7) ([1b5aa1a](https://github.com/rrambul/mindforge/commit/1b5aa1aa7f30dc1c0ff7ec081200456cce73bddb))
...
* **web:** fill the days you focused on the activity grid (FR-Q1) ([f1378bb](https://github.com/rrambul/mindforge/commit/f1378bb3a878beee84dbe7382485cf124d7a7955))
* **web:** fold a run's indexing warnings behind a toggle (FR-T3) ([efef9f8](https://github.com/rrambul/mindforge/commit/efef9f86641406ab6678754a65d7df75d1905f45))
